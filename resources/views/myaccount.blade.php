                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-3">
                            ...
                            <ul role="tablist" class="nav flex-column dashboard-list">
                                ...
                                <li> <a href="#orders" data-bs-toggle="tab" class="nav-link"><i class='bx bxs-package'></i> Danh sách đơn hàng</a></li>
                                @if (session()->has('account_id'))
                                <li><a href="{{ route('change.password.view') }}" class="nav-link"><i class='bx bxs-key'></i> Thay đổi mật khẩu</a></li>
                                @endif
                                <li><a href="{{ route('logout') }}" class="nav-link"><i class='bx bxs-log-in-circle'></i> Đăng xuất tài khoản</a></li>
                            </ul>
                        </div>
                        <div class="col-md-12 col-lg-9">
                            <!-- Tab panes -->
                            <div class="tab-content dashboard-content">
                                <div class="tab-pane fade @if(!session()->has('activeTab') || session('activeTab') === 'dashboard') show active @endif" id="dashboard">
                                    @if(session('success'))
                                ...
                                @endif
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-12 row">
                                                ...
                                                <div class="login-input-box col-md-3">
                                                    <div class="col_full">
                                                        ...
                                                        <input type="text" name="name" value="{{ $customer->name_customer }}" required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="login-input-box col-md-3">
                                                    <div class="col_full">
                                                        <label for="phone">Số điện thoại</label>
                                                        <input type="number" name="phone" value="{{ $customer->phone_customer }}" required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="login-input-box col-md-6">
                                                    <div class="col_full">
                                                        <label for="address">Địa chỉ</label>
                                                        <input type="text" name="address" value="{{ $customer->address_customer }}" required class="form-control">
                                                    </div>
                                                </div>
                                                <div class="login-input-box col-md-6">
                                        ...
                                        <div class="tab-pane fade @if(session('activeTab') === 'orders') show active @endif" id="orders">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-responsive table-bordered text-left my-orders-table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="last"><a href="{{ route('order.detail', ['orderId' => $order->id]) }}" style="color: #1d6cd9;font-weight: 600;">#{{ $order->code_order }}</a></td>
                                                                        ...
                                                                        <td class="text-center last">
                                                                            ...
                                                                            <a href="{{ route('cancel.order', ['orderId' => $order->id]) }}" class="btn-reorder">
