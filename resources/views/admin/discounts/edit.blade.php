                        ...
                        <div class=" row" bis_skin_checked="1">
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input value="{{ $discount->code }}" type="text" class="form-control" id="code"
                                        name="code" required>
                                </div>
                            </div>
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input value="{{ number_format($discount->discount, 0, '', ',') }}" type="text"
                                        oninput="formatNumber(this)" class="form-control" id="discount" name="discount"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input value="{{ number_format($discount->limit_number, 0, '', ',') }}" type="text"
                                        oninput="formatNumber(this)" class="form-control" id="limit_number"
                                        name="limit_number" >
                                </div>
                            </div>
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input value="{{ number_format($discount->number_used, 0, '', ',') }}" type="text"
                                        oninput="formatNumber(this)" class="form-control" id="number_used"
                                        name="number_used" required readonly>
                                </div>
                            </div>
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input
                                        ...
                                        type="text" class="form-control pickdate" id="expiration_date" required
                            ...
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input value="{{ number_format($discount->payment_limit, 0, '', ',') }}" type="text"
                                        oninput="formatNumber(this)" class="form-control" id="payment_limit"
