...
<div class="container">
    ...
    @endforeach
    @endif
    <form  method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" onsubmit="return validateForm()">
        @csrf
                        ...
                        <div class="row" bis_skin_checked="1">
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input type="text" class="form-control" id="name_product" name="name_product" required value="{{ old('name_product') }}">
                                </div>
                            </div>
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    <label for="sku" class="form-label">Mã sản phẩm</label>
                                    <a style="float: right;font-weight:600;color:rgb(0, 116, 194);cursor: pointer;" onclick="generateSKU()">Tự động tạo mã</a>
                            ...
                            <div class="col-md-6" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <input type="text" class="form-control" id="link_product" value="{{ old('link_product') }}" name="link_product" required>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <select class="form-control select2" id="colorSelect">
                                                ...
                                                <option value="{{ $color->id }}">{{ $color->desc_color }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4 d-flex" style="gap: 20px">
                                            <input class="form-control" type="number" id="quantity" placeholder="Số lượng">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row" bis_skin_checked="1">
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    <label for="link_product" class="form-label">Mô tả ngắn</label>
                        ...
                        <div class="row" bis_skin_checked="1">
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <select class="form-control select2" name="id_category" id="category" required>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('price_product') }}" oninput="formatNumber(this); calculateDiscount();" class="form-control" id="price_product" name="price_product" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="discount_percent" class="form-label">% Giảm</label>
                                    <input type="text" value="{{ old('discount_percent') }}" oninput="formatNumber(this); calculateDiscount();" class="form-control" id="discount_percent" name="discount_percent">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="sellprice_product" class="form-label">Giá giảm</label>
                                    <input type="text" value="{{ old('sellprice_product') }}" oninput="formatNumber(this); calculateSellPrice();" class="form-control" id="sellprice_product" name="sellprice_product">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3">
                                    ...
                                    <div id="imageContainer">
                                        <button class="remove-add-avt" type="button" onclick="removeImage()" id="removeBtn" style="display: none;">Xoá</button>
                                        <img class="avt-img" src="{{ URL::to('backend_area/assets/images/empty.jpg') }}" id="preview">
                                        <button class="button-add-avt" id="chooseBtn" type="button" onclick="document.getElementById('avt_product').click();"></button>
                                        <input type="file" class="form-control"  id="avt_product" name="avt_product" onchange="previewImage(event)" accept="image/*" style="display: none;">
                                ...
                                <div class="mb-3" id="multiImageWrapper">
                                    ...
                                    <div id="multiImageContainer">
                                        <div class="choose-multi-img">
                                            ...
                                            <input type="file" class="form-control" id="image_product" name="image_product[]" onchange="previewMultipleImages(event, 'image_product', 'imagePreview')" accept="image/*" multiple>
                                        </div>
...
<script>
    ...
    function calculateDiscount() {
        ...
        if (!isNaN(price) && !isNaN(discountPercent)) {
            ...
            sellPriceInput.value = Math.round(sellPrice).toLocaleString('en-US');
        }
    }
...
<script>
    ...
    function addVariant() {
        ...
        const exists = selectedVariants.find(variant => variant.color === selectedColor && variant.size === selectedSize);
    ...
    document.addEventListener('click', function(e) {
        ...
        const confirmDelete = Swal.fire({
            ...
            const indexToRemove = selectedVariants.findIndex(variant => variant.color === colorDiv && variant.size === sizeDiv);
            if (indexToRemove !== -1) {
