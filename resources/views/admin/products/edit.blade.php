...
<div class="container">
    ...
    @endforeach
    @endif
    <form method="post" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data" onsubmit="return validateForm()">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name_product" name="name_product"
                                        required value="{{ $product->name_product ?? old('name_product') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="sku" name="sku"
                                        value="{{ $product->sku ?? old('sku') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="variants">
                                        ...
                                        <div class="variant-row" data-variant-id="{{ $variant->id }}">
                                            ...
                                            <input class="quantity-input" type="text" value="{{ $variant->quantity }}"
                                                readonly>
                        ...
                        <div class="row" bis_skin_checked="1">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control ckeditor" id="desc_product"
                                        name="desc_product">{{ $product->desc_product ?? old('desc_product') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3" bis_skin_checked="1">
                                    ...
                                    <select class="form-control select2" name="id_category" id="category" required>
                                        ...
                                        @continue
                                        @endif
                                        <option value="{{ $category->id }}" {{ $product->id_category == $category->id ?
                                            'selected' : '' }}>
                                            {{ $category->name_category }}
                                        </option>
                                        @if ($category->children)
                                        @foreach ($category->children as $child)
                                        <option value="{{ $child->id }}" {{ $product->id_category == $child->id ?
                                            'selected' : '' }}>
                                            - {{ $child->name_category }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="price_product" name="price_product" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12" bis_skin_checked="1">
                                <div class="mb-3">
                                    ...
                                    <div id="imageContainer">
                                        ...
                                        <input type="file" class="form-control" id="avt_product" name="avt_product"
                                            onchange="previewImage(event)" accept="image/*" style="display: none;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div id="imagePreview">
                                            ...
                                            <div class="imgmulti">
                                                <img src="/img/products/{{ $product->id }}/{{ $imageName }}"
                                                    alt="{{ $imageName }}">
                                                <button onclick="removeImage(this, '{{ $imageName }}')">Xoá</button>
                                            </div>
                                            @endif
                                            @endforeach
                                        </div>
...
<script>
    ...
    if (e.target && e.target.classList.contains('quantity-input')) {
        ...
        if (variantInputs.length > variantIndex) {
            variantInputs[variantIndex].setAttribute('value', JSON.stringify(selectedVariants[variantIndex]));
        }
    }
});
