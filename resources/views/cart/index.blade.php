                                            ...
                                            <div class="media-left">
                                                <div class="item-img">
                                                    <a href="{{ route('products.show', ['linkProduct' => $item['linkproduct']]) }}">
                                                        <img src="{{ asset('img/products/' . $productid . '/' . $item['image']) }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="item-remove">
                                                    <a class="removeFromCart" data-product="{{ $cartKey }}"><i
                                            ...
                                            <div class="media-right">
                                                <div class="item-info">
                                                    <h3 class="item--title"><a
                                                            href="{{ route('products.show', ['linkProduct' => $item['linkproduct']]) }}">{{ $item['name']
                                                            }}</a></h3>
                                                </div>
                                                ...
                                                <div class="item-qty" style="width: 120px;" bis_skin_checked="1">
                                                    <div class="quantity" bis_skin_checked="1">
                                                        ...
                                                        <div class="quantity-nav" bis_skin_checked="1">
                                                            <div class="changeQuantity quantity-button quantity-up" data-product="{{ $cartKey }}" data-action="increase"
                                                                bis_skin_checked="1">+</div>
                                                            <div class="changeQuantity quantity-button quantity-down" data-product="{{ $cartKey }}" data-action="decrease"
                                                                bis_skin_checked="1">-</div>
                                                        </div>
                                                    </div>
                                                </div>
...
$('.quantity-input').on('input', function () {
    ...
    // Kiểm tra nếu số lượng nhỏ hơn 1, đặt lại thành 1
    if (newQuantity < 1) {
        newQuantity = 1;
    ...
    .then(function (response) {
        ...
        // Load lại trang giỏ hàng sau khi thay đổi thành công
    ...
    button.addEventListener('click', function() {
        ...
        // // Script để xử lý Ajax khi nhấn nút remove
        ...
        //         .then(function (response) {
        //             //alert(response.data.message);
        //             // Load lại trang giỏ hàng sau khi xóa thành công
        //             window.location.reload();
        //         })
        //         .catch(function (error) {
        //             console.error(error);
