...
<body>
    <div class="container">
        ...
        <p>
            <a style="background: rgb(5, 185, 125)221, 221);color:white;padding:5px;border-radius:5px;margin-top:5px;margin-bottom:5px;"
            href="{{ route('reset.password.form', ['token' => $token]) }}">Khôi phục mật khẩu</a></p>
